...
public class MongoRepository implements Repository {
    ...
    private final Map<Long, Auction> auctionMap = new ConcurrentHashMap<Long, Auction>();
...
//        }, 0, 1000);
    ...
    private Event parseEvent(Document d) {
        ...
        long timestamp = LocalDateTime.ofInstant(((Date) d.get("timestamp")).toInstant(), ZoneId.systemDefault());
        long auctionId = UUID.fromString(d.get("aggregateId").toString());
        Event event;
